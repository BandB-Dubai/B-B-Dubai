...
const IMAGE_MAP = [
  ...
  {
    src: "B&Blogo.jpeg",
    out: "assets/images/bb-dubai-logo.png",
    quality: 85,
    maxW: 300,
  ...
  // ── CLIENT LOGOS ───────────────────────────────────────────────────────────
  {
    src: "assets/images/OUR CLIENTS/AL GHURAIR.png",
    out: "assets/images/clients/client-al-ghurair.webp",
    quality: 85,
    maxW: 400,
    alt: "Al Ghurair logo",
  },
  {
    src: "assets/images/OUR CLIENTS/AL KHAYAM.png",
    out: "assets/images/clients/client-al-khayam.webp",
    quality: 85,
    maxW: 400,
    alt: "Al Khayam logo",
  },
  {
    src: "assets/images/OUR CLIENTS/AL RASHIDEEN.png",
    out: "assets/images/clients/client-al-rashideen.webp",
    quality: 85,
    maxW: 400,
    alt: "Al Rashideen logo",
  },
  {
    src: "assets/images/OUR CLIENTS/ASTER.png",
    out: "assets/images/clients/client-aster-hospitals.webp",
    quality: 85,
    maxW: 400,
    alt: "Aster Hospitals logo",
  },
  {
    src: "assets/images/OUR CLIENTS/BIG BUS.png",
    out: "assets/images/clients/client-big-bus-dubai.webp",
    quality: 85,
    maxW: 400,
    alt: "Big Bus Dubai logo",
  },
  {
    src: "assets/images/OUR CLIENTS/CAR TAXI.png",
    out: "assets/images/clients/client-car-taxi.webp",
    quality: 85,
    maxW: 400,
    alt: "Car Taxi logo",
  },
  {
    src: "assets/images/OUR CLIENTS/CONMIX.png",
    out: "assets/images/clients/client-conmix.webp",
    quality: 85,
    maxW: 400,
    alt: "Conmix Ltd logo",
  },
  {
    src: "assets/images/OUR CLIENTS/D TAXI.png",
    out: "assets/images/clients/client-dubai-taxi.webp",
    quality: 85,
    maxW: 400,
    alt: "Dubai Taxi logo",
  },
  {
    src: "assets/images/OUR CLIENTS/DCC.png",
    out: "assets/images/clients/client-dubai-contracting.webp",
    quality: 85,
    maxW: 400,
    alt: "Dubai Contracting Company logo",
  },
  {
    src: "assets/images/OUR CLIENTS/deep sea logo.png",
    out: "assets/images/clients/client-deep-sea-food.webp",
    quality: 85,
    maxW: 400,
    alt: "Deep Sea Food Company logo",
  },
  {
    src: "assets/images/OUR CLIENTS/ECC.png",
    out: "assets/images/clients/client-ecc.webp",
    quality: 85,
    maxW: 400,
    alt: "ECC logo",
  },
  {
    src: "assets/images/OUR CLIENTS/GERMAN.png",
    out: "assets/images/clients/client-german-gulf.webp",
    quality: 85,
    maxW: 400,
    alt: "German Gulf Enterprises logo",
  },
  {
    src: "assets/images/OUR CLIENTS/GMGT.png",
    out: "assets/images/clients/client-gmgt.webp",
    quality: 85,
    maxW: 400,
    alt: "GMGT logo",
  },
  {
    src: "assets/images/OUR CLIENTS/KSB.png",
    out: "assets/images/clients/client-ksb-energy.webp",
    quality: 85,
    maxW: 400,
    alt: "KSB World Class Energy logo",
  },
  {
    src: "assets/images/OUR CLIENTS/MDT.png",
    out: "assets/images/clients/client-mdt.webp",
    quality: 85,
    maxW: 400,
    alt: "MDT logo",
  },
  {
    src: "assets/images/OUR CLIENTS/MUNCIPALITY.png",
    out: "assets/images/clients/client-dubai-municipality.webp",
    quality: 85,
    maxW: 400,
    alt: "Dubai Municipality logo",
  },
  {
    src: "assets/images/OUR CLIENTS/ROMANA.png",
    out: "assets/images/clients/client-romana-water.webp",
    quality: 85,
    maxW: 400,
    alt: "Romana Water logo",
  },
  {
    src: "assets/images/OUR CLIENTS/SONAS.png",
    out: "assets/images/clients/client-sonas.webp",
    quality: 85,
    maxW: 400,
    alt: "Sonas logo",
  },
  {
    src: "assets/images/OUR CLIENTS/TALAL.png",
    out: "assets/images/clients/client-talal-group.webp",
    quality: 85,
    maxW: 400,
    alt: "Talal Group logo",
  },
];
...
async function main() {
  ...
  for (const item of IMAGE_MAP) {
    ...
    try {
      ...
      if (item.maxW) {
        pipeline = pipeline.resize(item.maxW, null, {
          withoutEnlargement: true,
        });
      }

      await pipeline.webp({ quality: item.quality, effort: 4 }).toFile(outAbs);
      ...
      console.log(
        `  ${tag}  ${label}  ${fmt(srcSize).padStart(8)} → ${fmt(outSize).padStart(7)}  (${pct}% saved)`,
      );
  ...
  console.log("\n" + "─".repeat(60));
  console.log(
    `  Images processed : ${IMAGE_MAP.length - errors} / ${IMAGE_MAP.length}`,
  );
  console.log(`  Errors           : ${errors}`);
  console.log(`  Total input      : ${fmt(totalIn)}`);
  console.log(`  Total output     : ${fmt(totalOut)}`);
  console.log(
    `  Total saved      : ${fmt(totalSaved)} (${((totalSaved / totalIn) * 100).toFixed(1)}%)`,
  );
